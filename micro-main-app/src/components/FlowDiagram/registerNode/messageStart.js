export default function messageStart(lf) {
  lf.register("messageStart", ({ CircleNode, CircleNodeModel, h }) => {
    class MessageStartNode extends CircleNode {
      getIconShape() {
    ...
    class MessageStartModel extends CircleNodeModel {
    ...
    return {
      view: MessageStartNode,
      model: MessageStartModel
    };
  });
}
