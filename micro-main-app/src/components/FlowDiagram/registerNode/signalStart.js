export default function signalStart(lf) {
  lf.register("signalStart", ({ CircleNode, CircleNodeModel, h }) => {
    class SignalStartNode extends CircleNode {
      getIconShape() {
    ...
    class SignalStartModel extends CircleNodeModel {
    ...
    return {
      view: SignalStartNode,
      model: SignalStartModel
    };
  });
}
